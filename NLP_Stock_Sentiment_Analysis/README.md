...
├── stock_news.csv                            # optional (Zenodo DOI available)
├── arxiv_paper/
│   ├── NLP_Stock_Sentiment_Analysis_arXiv.pdf
...
```
Roy, Joyjit. “NLP Stock Sentiment Analysis: A Comparative Embedding-Based Approach.”
arXiv preprint, 2025.
```
